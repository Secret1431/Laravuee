<template>
    <div class="flex justify-end mt-80 text-sm">
        <div class="flex items-center space-x-4">
            <div class="flex items-center space-x-4">
                <span>Row per page:</span>
                <select
                    v-model="itemperPage"
                    class="border border-gray-300 py-1 px-2 text-center rounded focus:ring-1 focus:ring-blue-500"
                    >
...
const { page, itemperPage, setPage } = useCustomerStore();
const totalItems = 50;
